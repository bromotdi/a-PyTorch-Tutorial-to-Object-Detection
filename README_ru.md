...
**Построение модели, которая определяет местоположение конкретных объектов на изображениях.**
...
Дополнительные примеры можно найти [тут](https://github.com/sgrvinod/a-PyTorch-Tutorial-to-Object-Detection#some-more-examples).
...
В этом разделе я представлю обзор SSD модели. Если вы уже знакомы с ним, вы можете сразу перейти к разделу [Реализация](https://github.com/sgrvinod/a-PyTorch-Tutorial-to-Object-Detection#implementation) или к коду с комментариями.
